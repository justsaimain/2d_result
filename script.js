...
$(document).ready(function () {
    ...
    const getData = function () {
        setInterval(() => {
            var today = new Date();
            now_hour = today.getHours() + ":" + today.getMinutes();
        }, 5000);
        if (now_hour > "12:01") {
            console.log("12:01 and get noon final data");
            getNoonFinalData();
            if (now_hour > "16:31") {
                console.log("4:30 and get evening final data");
                getEveningFinalData();
            } else {
                if (now_hour > "15:00") {
                    console.log(
                        "3:00 and working before 4:30 getting evening data"
                    );
                    gettingEveningData();
                    setInterval(() => {
                        gettingEveningData();
            ...
            if (now_hour > "9:00") {
                console.log("9:00 and getting noon data before 12:01");
                getttingNoonData();
                setInterval(() => {
                    getttingNoonData();
                }, 5000);
